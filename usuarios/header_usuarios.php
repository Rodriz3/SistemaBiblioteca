...
<head>
    ...
    <style>
        /* Estilo personalizado para los botones específicos de usuarios */
        .usuarios-btn {
        ...
        /* Cambiar el color de todas las letras dentro de la página de usuarios a blanco */
        body, body * {
...
<body>
    <div class="container mt-5 text-center">
        ...
        <div class="d-flex flex-wrap justify-content-center mb-4">
            <div class="btn-group flex-wrap" role="group" aria-label="Acciones de usuarios">
                <a href="agregar_usuario.php" class="btn usuarios-btn mx-2 mb-2">Agregar</a>
                <a href="usuarios_lista.php" class="btn usuarios-btn mx-2 mb-2">Lista</a>
                <a href="comentarios_aprobar.php" class="btn usuarios-btn mx-2 mb-2">Comentarios</a>
                <a href="exportar_usuarios.php" class="btn usuarios-btn mx-2 mb-2">Exportar</a>
            </div>
        </div>
    </div>
