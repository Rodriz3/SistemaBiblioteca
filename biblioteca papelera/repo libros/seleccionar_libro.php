...
<body>
    <div class="container mt-5">
        ...
        <form class="form-inline mb-4" method="GET" action="seleccionar_libro.php">
            <input type="text" name="titulo" class="form-control mr-2" placeholder="Buscar por título" value="<?php echo isset($_GET['titulo']) ? htmlspecialchars($_GET['titulo']) : ''; ?>">
            <input type="text" name="autor" class="form-control mr-2" placeholder="Buscar por autor" value="<?php echo isset($_GET['autor']) ? htmlspecialchars($_GET['autor']) : ''; ?>">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="booksTableBody">
                ...
                $sql = "SELECT FECHA, AUTOR, TITULO, EDITORIAL, ISBN, D, PERSONA, ID, ESTANTE, categoria, categoria2 
                        FROM libros 
                        WHERE AUTOR LIKE '%$autor%' AND TITULO LIKE '%$titulo%' 
                        ORDER BY ID DESC";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='12'>No hay libros disponibles</td></tr>";
                }
    ...
    <script>
        function openEditModal(book) {
            ...
            document.getElementById('edit_fecha').value = book.FECHA;
